...
describe 'Test Service Objects' do
  before do
    @credentials = { username: 'isa.belle', password: 'mypassword' }
    @mal_credentials = { username: 'isa.belle', password: 'anyonepassword' }
    @api_account = { account:
                       { username: 'isa.belle', email: 'isa.belle@nthu.edu.tw' } }
